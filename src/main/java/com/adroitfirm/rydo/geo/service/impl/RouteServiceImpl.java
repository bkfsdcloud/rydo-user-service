...
//        		.encodedPath(route.overviewPolyline.getEncodedPath())
        		.coordinates(mapUtil.decodePolyline(route.overviewPolyline.getEncodedPath()))
//        		.coordinates1(route.overviewPolyline.decodePath().stream()
//        				.map(latLng -> Map.of("latitude", latLng.lat, "longitude", latLng.lng))
